...
function Image () {
    return <>
        <div>
        <h1>There are some images of animals</h1>
    </div>
    <div class="pngbox fn-clear">
        <div class="fl">
            <a href="javascript:;">
                <img src="https://wallpapershome.com/images/pages/ico_h/19407.jpg" class="menusomething"/>
            </a>
        </div>
        <div class="fl">
            <a href="javascript:;">
                <img src="https://wallpapershome.com/images/pages/ico_h/14873.jpg" class="menusomething"/>
            </a>
        </div>
        <div class="fl">
            <a href="javascript:;">
                <img src="https://wallpapershome.com/images/pages/ico_h/23198.jpg" class="menusomething"/>

            </a>
        </div>
        <div class="fl">
            <a href="javascript:;">
                <img src="https://wallpapershome.com/images/pages/ico_h/23222.jpg" class="menusomething"/>
            </a>
        </div>
        <div class="fl">
            <a href="javascript:;">
                <img src="https://wallpapershome.com/images/pages/ico_h/19676.jpg" class="menusomething"/>
            </a>
        </div>
        <div class="fl">
            <a href="javascript:;">
                <img src="https://wallpapershome.com/images/pages/ico_h/20031.jpg" class="menusomething"/>
            </a>
        </div>
        <div class="fl">
            <a href="javascript:;">
                <img src="https://wallpapershome.com/images/pages/ico_h/18612.jpg" class="menusomething"/>
            </a>
        </div>
        <div class="fl">
            <a href="javascript:;">
                <img src="https://wallpapershome.com/images/pages/ico_h/18845.jpg" class="menusomething"/>
            </a>
        </div>
        <div class="fl">
            <a href="javascript:;">
                <img src="https://wallpapershome.com/images/pages/ico_h/16741.jpg" class="menusomething"/>
            </a>
        </div>
        <div class="fl">
            <a href="javascript:;">
    ...
    <a href="javascript:;" id="top">
        <svg t="1611743395816" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="2177" width="64" height="64">
            <path
